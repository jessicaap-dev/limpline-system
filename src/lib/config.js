...
export const PRODUCTS = [
  ...
  { id: 8, name: 'Papel Higiênico Cai-Cai com 8.000 folhas', units: ['Caixa'] },
  { id: 9, name: 'Papel Higiênico Rolão 8x300 mts Luxo', units: ['Fardo'] },
  { id: 10, name: 'Papel Higiênico Rolão 8x300 mts Premium', units: ['Fardo'] },
  { id: 11, name: 'Papel Higiênico Rolão Folha Dupla 8x240 mts', units: ['Fardo'] },
  { id: 12, name: 'Sabonete Espuma Sache', units: ['Caixa', 'Unidade'] },
  { id: 13, name: 'Sabonete Espuma Antisséptico', units: ['Caixa', 'Unidade'] },
  { id: 14, name: 'Sabonete Espuma Galão com 5 lts', units: ['Caixa', 'Unidade'] },
  { id: 15, name: 'Sabonete Cremoso Galão com 5 lts', units: ['Caixa', 'Unidade'] },
  { id: 16, name: 'Álcool Gel Sache com 800 ml', units: ['Caixa', 'Unidade'] },
  { id: 17, name: 'Álcool Spray Sache com 800 ml', units: ['Caixa', 'Unidade'] },
  { id: 18, name: 'Álcool Gel Galão com 5 lts', units: ['Caixa', 'Unidade'] },
  { id: 19, name: 'Protetor de Assento Sanitário com 86 folhas', units: ['Caixa', 'Pacote'] },
